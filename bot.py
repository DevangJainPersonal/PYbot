...
PAYMENT_CHANNEL = "@TESTBO_OOT" #add payment channel here including the '@' sign
OWNER_ID = 1177055920 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@TESTBO_OO"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
