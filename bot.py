...
BOT_TOKEN = "5181871420:AAGaurJSSx3HnhorufBMTZz4PIO6eIMa27o"
PAYMENT_CHANNEL = "@jejujabo" #add payment channel here including the '@' sign
OWNER_ID = 1177055920 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@jejujabo"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
