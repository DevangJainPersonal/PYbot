        ...
        if ch == True:
            ...
            if user not in data['refer']:
                ...
                if int(data['referby'][user]) != user_id:
                    ...
                    data['referred'][ref] += 1
                    bot.send_message(
                        ref_id, "<b>💰New Refer +"+str(Per_Refer)+" "+str(TOKEN)+"</b>", parse_mode="html")
                    json.dump(data, open('paytmusers.json', 'w'),indent=4)
